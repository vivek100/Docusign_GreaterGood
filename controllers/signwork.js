...
exports.openSigningCeremonyController = async (req, res, next) => {
  try {
        ...
        const fileName = 'demo_documents/workcertificate.docx';
        ...
        envDef.emailSubject = 'Volunteer Work Certificate for '+ req.body.ccname;
        envDef.emailBlurb = 'Volunteer Work Certificate for '+ req.body.ccname;
        ...
        const doc = docusign.Document.constructFromObject({documentBase64: doc2b64,
              ...
              name: 'Volunteer Work form', documentId: '1'});
        ...
        const textuname = docusign.Text.constructFromObject({
                ...
                anchorYOffset: '-16', anchorXOffset: '4',
        ...
        const texthelptype = docusign.Text.constructFromObject({
            anchorString: '/helptype/', anchorUnits: 'pixels',
            anchorYOffset: '-8', anchorXOffset: '4',
            font: 'helvetica', fontSize: 'size14',
            bold: 'false', value: req.body.helptype,
            locked: 'true', tabId: 'helptype',
            tabLabel: 'helptype'
        })

      const texthelpdetails = docusign.Text.constructFromObject({
          anchorString: '/helpdetails/', anchorUnits: 'pixels',
          anchorYOffset: '-8', anchorXOffset: '4',
          font: 'helvetica', fontSize: 'size14',
          bold: 'false', value: req.body.helpdetails,
          locked: 'true', tabId: 'helpdetails',
          tabLabel: 'helpdetails'
      })

      const textcomments = docusign.Text.constructFromObject({
          anchorString: '/comments/', anchorUnits: 'pixels',
          anchorYOffset: '-8', anchorXOffset: '4',
          font: 'helvetica', fontSize: 'size14',
          bold: 'false', value: 'Add your comments here',
          locked: 'false', tabId: 'comments',
          tabLabel: 'comments'
      })
        ...
        signer.tabs = docusign.Tabs.constructFromObject({signHereTabs: [signHere],
          textTabs: [textname, textuname,texthelptype,texthelpdetails,textcomments]});
